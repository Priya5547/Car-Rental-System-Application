...
public class myadepter extends BaseAdapter
{
    ...
    TextView textView;
    public myadepter(Context mainActivity, ArrayList name, ArrayList city, ArrayList model, ArrayList price, ArrayList img)
    {
        this.name=name;
        this.city=city;
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        convertView=layoutInflater.inflate(R.layout.fragment_view_car,parent,false);
        TextView t = convertView.findViewById(R.id.name);
        t.setText(name.get(position));
        TextView t1 = convertView.findViewById(R.id.city);
        t1.setText("City:"+city.get(position));
        TextView t2 = convertView.findViewById(R.id.model);
        t2.setText("Model:"+model.get(position));
